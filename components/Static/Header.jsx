            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        ...
                        <p className=" font-extrabold ml-1 text-2xl">Yuzu</p>
                    </div>
            ...
            <header>
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/" className="text-amber-400">Yuzu</a>
                            </p>
                        </div>
                    ...
                    <div className="flex items-center space-x-2 relative">
                        ...
                        <Link href="https://discord.com/api/oauth2/authorize?client_id=1024893673080635483&permissions=277028603968&scope=applications.commands%20bot">
